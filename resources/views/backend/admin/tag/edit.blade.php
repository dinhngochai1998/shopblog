...
<div class="wrapper">
    ...
    <div class="content-wrapper" style="min-height: 1602px;">
        ...
        <section class="content">
            <form novalidate="novalidate" method="POST" action="{{ route('tag.update', $tag->id) }}" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-body">                       
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ $tag->name }}" id="inputName" class="form-control" required />
                                </div>                      
                            </div>
                            <!-- /.card-body -->
                        </div>
